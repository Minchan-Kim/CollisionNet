...
def write(data, src, dest, time_window, tools, dtype):
    ...
    filename = dest + '/vt{}_'.format(file_index) + description
...
parser.add_argument('path', nargs = '?', default = '/home/dyros/mc_ws/CollisionNet/data/32/validation_as_training')
...
paths = list(path.glob('ValidationSet/**/Reduced_DRCL_ValidationData.txt'))
